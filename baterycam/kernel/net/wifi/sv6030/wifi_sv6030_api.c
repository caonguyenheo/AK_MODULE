...
int wifi_power_cfg(unsigned char power_save_level)
{
    ...
    return sv6030_wifi_power_cfg(power_save_level);
}
...
int wifi_set_mode(int type)
{
    ...
    return sv6030_wifi_set_mode(type);;
}
...
{
    return sv6030_wifi_isconnected();
}
...
{
	return sv6030_wifi_connect(essid, key);
}
...
int wifi_create_ap(struct _apcfg *ap_cfg)
{
	...
	//wifi_power_cfg(0);
	return sv6030_wifi_create_ap(ap_cfg);
}
...
{
    //do nothing
    return sv6030_wifi_destroy_ap();
}

int wifi_list_station(struct sta_info_t *sta, int count)
{
	//return sv6030_wifi_sleep(sta, count);
}

int wifi_sleep()
{
	//return sv6030_wifi_sleep();
}

int wifi_wakeup()
{
	//return sv6030_wifi_wakeup();
}
/**
...
{
	return sv6030_wifi_ap_cfg(name,dot11n_enable,key,key_type,channel,max_client);
}
...
{
    return sv6030_wifi_get_tx_pending();
}
/**
*wmj+ 
...
{
    return sv6030_wifi_set_max_tx_pending();
}
...
{
	return sv6030_wifi_get_max_tx_pending();
}
