...
/*****************************************
 * @brief open file for save video stream
 * @param void
 * @return  on success return  fd handle, on fail return NULL
 *****************************************/
...
/*****************************************
 * @brief save a frame data to file
 * @param filp[in]  file handle
 * @param data[in]  video stream data
...
/*****************************************
 * @brief get venc stream,and save to file
 * @param arg[in]  
 * @return void
 *****************************************/
    ...
    for(i=0 ;i< argc;i++)
    {
        switch(i)
        {
            case 0:
				...
				g_rec_para.frame_count = strtol(args[i], &p_end_tmp, 10 );

                if (g_rec_para.frame_count<=0 || *p_end_tmp != '\0')
                {
            ...
            case 2:            
                /* fps */
                g_rec_para.fps= strtol(args[i], &p_end_tmp, 10 );
            ...
            case 3:
                 /* bitrate */
                g_rec_para.kbps= strtol(args[i], &p_end_tmp, 10 );
