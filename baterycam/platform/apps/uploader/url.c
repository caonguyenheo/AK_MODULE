...
#else
    printf("Check URL SSL1\r\n");
    // invalid = invalid || url->scheme == NULL || strcmp(url->scheme, "https");
    invalid = invalid || url->scheme == NULL;
    if(strcmp(url->scheme, "https") != 0)
    {
        invalid = invalid || strcmp(url->scheme, "http");
    }
    else
    {
        invalid = invalid || strcmp(url->scheme, "https");
    }
#endif
