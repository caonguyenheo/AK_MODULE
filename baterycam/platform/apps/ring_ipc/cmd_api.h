...
typedef struct _cmd_info {
	...
	union {
        ...
        struct  _wakeup_para{
            unsigned char wakeup_source;        // EVENT_PIR_WAKEUP EVENT_RING_CALL_WAKEUP
            unsigned char wifi_init_flag;       // 0: init 1:fastlink
            unsigned char day_night;            // 0: day  1:night
...
#define	CMD_RING_DINGDONG 		    0x03    //叮咚id
#define CMD_SYS_CONFIG				0x04
#define CMD_SLEEP_REQ				0x05

#define CMD_BATTERY_VAL 		    0x06    //电量回应，cmd_result电量值
#define CMD_BATTERY_GET_VAL 		0x07    //ak发的回去电量请求
#define CMD_SYS_RESTART_REQ         0x08    //ak重新上电请求
#define CMD_SLEEP_REQ_PRE			0x09
...
/*result define*/
#define RESULT_WIFI_CONFIG_CLEAR    0xffff



/*event define*/
#define EVENT_NULL_WAKEUP  		  	0x00
