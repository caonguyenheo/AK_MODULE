    ...
    for(i=0 ;i< argc;i++)
    {
        switch(i)
        {
            case 0:
				...
				g_video_config.saveTime = strtol(args[i], &p_end_tmp, 10 );
                if (g_video_config.saveTime <=0 || *p_end_tmp != '\0')
                {
            ...
            case 2:            
                /* rec_fps */
                g_video_config.savefilefps = strtol(args[i], &p_end_tmp, 10 );
            ...
            case 3:            
                /* cap_fps */
                g_cap_fps = strtol(args[i], &p_end_tmp, 10 );
            ...
            case 4:
                 /* bitrate */
                g_video_config.savefilekbps = strtol(args[i], &p_end_tmp, 10 );
