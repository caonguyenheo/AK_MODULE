 ...
 * @brief venc init
 * @param void
 * @return on success return venc handler, fail return NULL
 *****************************************/
...
/*****************************************
 * @brief get yuv video stream
 * @param vi_handle[in]  the video handle
 * @param enc_handle[in]  the venc handle
 * @return void
 *****************************************/
...
#if VI_CHANGE_ATTR_DBG
/*****************************************
 * @brief change vi attr to vga
 * @param vi_handle[in]  the video handle
 * @return void
 *****************************************/
