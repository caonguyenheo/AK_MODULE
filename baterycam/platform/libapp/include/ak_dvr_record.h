 ...
 * return: none
 */
void ak_dvr_record_start(int trigger_type);
...
/** 
 * ak_dvr_record_set_trigger_time - set alarm record trigger time
 ...
 */
void ak_dvr_record_set_trigger_time(int trigger_time);
