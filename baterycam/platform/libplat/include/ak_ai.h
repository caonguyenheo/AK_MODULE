 ...
 * @param[in] param return the info
 * @return int
 ...
 * @date   2016-11-23
 * @param[in] handler handler of the sound device  
 * @param[in] frame return buffer address or AK_NULL
 * @param[in] ms
 * @return int
 ...
 * @retval -1 set failed
 */
// notice:  This API must be call before  "ak_ai_get_frame()";
 ...
 * @date   2016-11-23
 * @param[in] handler handler of the sound device
 * @param[in] volume  the gain of sound device   volume:0~12
 * @return int
 * @retval 0  set successful
 * @retval -1 set failed
 */
