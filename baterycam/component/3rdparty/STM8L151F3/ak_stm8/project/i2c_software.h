 ...
 */
unsigned short i2c_set_cycle_delay(unsigned short delay);
 ...
 * @retval true operation successful
 */
bool i2c_write_cmd_read_data(unsigned char daddr, unsigned char raddr, unsigned char *data, unsigned short ReSize);
